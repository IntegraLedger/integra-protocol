...
This project is the reference implementation of the **Legal Context Protocol (LCP)**, co-stewarded by
Integra Ledger and AAA-ICDR. Contributors arrive from software, from legal practice, and from standards
work, and they will not share a professional culture. That is the reason to state expectations plainly
rather than assume them.

The text below is the [Contributor Covenant][homepage], version 2.1, adopted substantially verbatim. It is
kept close to the standard on purpose: its usefulness comes from being a document contributors already
recognise and can rely on, not from our wording of it.
...
responsible for enforcement at **conduct@integraledger.com**.

All complaints will be reviewed and investigated promptly and fairly.

All community leaders are obligated to respect the privacy and security of the reporter of any incident.

**A technical disagreement is not a conduct matter.** Disputes about the protocol, an implementation, or a
review are worked in the open through issues and pull requests — see [CONTRIBUTING.md](CONTRIBUTING.md).
This address is for conduct, and using it to escalate a technical argument is not appropriate. Security
vulnerabilities have their own private channel; see [SECURITY.md](SECURITY.md).
