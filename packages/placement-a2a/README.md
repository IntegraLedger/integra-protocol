...
release, not at it), gate discharged 2026-07-30, and reconciled against LCP §C.8 the same day; re-read
against **LCP §C.8** on 2026-08-12, which now states `AgentExtension`'s four fields. The kit is `makePlacement` from
