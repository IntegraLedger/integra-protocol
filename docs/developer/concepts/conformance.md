...
Rust, Go or Python. Of the 856 registered cases, 131 assert a refusal this way — a conformant implementation
...
**Today the corpus is 856 cases across 44 areas.** That number is not a fact about this page; it is a fact
...
`0 failed` reads identically whether 856 cases ran or six did. So the counts are what gets reported, not the
