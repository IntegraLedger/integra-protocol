...
Rust, Go or Python. Of the 865 registered cases, **226 assert a failure rather than a value** — 95 pin a
...
**Today the corpus is 865 cases across 44 areas.** That number is not a fact about this page; it is a fact
...
`0 failed` reads identically whether 865 cases ran or six did. So the counts are what gets reported, not the
