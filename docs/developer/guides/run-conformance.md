...
```text
corpus: 44/44 areas, 848/848 cases, root 9bad34c99a1f87a8… (authentic)
```
...
- **`848 passed`** — the size of the corpus that actually ran. Quote this number, not the exit code. A green
...
{"class":"schema","input":{"atrVersion":"0.3","terms":"# Terms","id":"0x9f8b7a6c5d4e3f2a1b0c9d8e7f6a5b4c"},"schema":{"$schema":"https://json-schema.org/draft/2020-12/schema", …}}
```
...
// State the phase. `runCorpus` defaults to "P1" — 95 of the 848 cases — where the CLI defaults to
