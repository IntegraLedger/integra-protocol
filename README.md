...
```bash
pnpm install
pnpm verify          # floor-provenance → runner-patch → versions → docblocks → declared-imports → hermetic-tests → weld-grade-keys → live-rails → harness-proof → corpus-seal → advisories
